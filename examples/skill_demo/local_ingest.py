"""Local Console-ingest emulator for the v0.2 e2e spike.

Mimics the future Console's ``POST /v0/events`` endpoint so a Baton-instrumented
MCP server can ship events to a real HTTPS target during local development.
